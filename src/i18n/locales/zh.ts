export default {
  translation: {
    ...
    'Please write some content': '请填写正文内容',
    'Article published': '长文已发布',
    'Failed to publish article': '长文发布失败',
    'Untitled article': '无标题长文',
    'Your article preview will appear here.': '长文预览将显示在这里。',
    'Draft saved': '草稿已保存',
    Saved: '已保存',
    'Article title': '长文标题',
    Summary: '摘要',
    'A short introduction shown before the article (optional)': '显示在正文前的简短介绍（可选）',
    'Cover image': '封面图片',
    'A wide image works best (optional)': '建议使用宽幅图片（可选）',
    'Cover image URL': '封面图片链接',
    Topics: '主题',
    'Add up to 6 topics, then press Enter': '最多添加 6 个主题，按回车确认',
    words: '字词',
    'Start writing in Markdown...': '使用 Markdown 开始撰写…',
    Heading: '标题',
    Bold: '粗体',
    Italic: '斜体',
    'Bulleted list': '无序列表',
