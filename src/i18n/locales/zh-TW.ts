export default {
  translation: {
    ...
    'Write article': '撰寫長文',
    'New note': '發布短帖',
    'Please add a title': '請新增標題',
    'Please write some content': '請填寫正文內容',
    'Article published': '長文已發布',
    'Failed to publish article': '長文發布失敗',
    'Untitled article': '無標題長文',
    'Your article preview will appear here.': '長文預覽將顯示在這裡。',
    'Draft saved': '草稿已儲存',
    Saved: '已儲存',
    'Article title': '長文標題',
    Summary: '摘要',
    'A short introduction shown before the article (optional)': '顯示於正文前的簡短介紹（可選）',
    'Cover image': '封面圖片',
    'A wide image works best (optional)': '建議使用寬幅圖片（可選）',
    'Cover image URL': '封面圖片連結',
    Topics: '主題',
    'Add up to 6 topics, then press Enter': '最多新增 6 個主題，按 Enter 確認',
    words: '字詞',
    'Start writing in Markdown...': '使用 Markdown 開始撰寫…',
    Heading: '標題',
    Bold: '粗體',
    Italic: '斜體',
    ...
    'To-do list': '待辦清單',
    'Short note': '短文',
    'Long-form article': '長文',
    'Share a thought or a moment': '分享想法，記錄此刻',
    'Give your ideas more room': '展開思緒，寫得更深入',
    Publish: '發布',
